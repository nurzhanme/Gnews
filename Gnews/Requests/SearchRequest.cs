...
public class SearchRequest
{
    ...
    /// <summary>
    /// This parameter allows you to choose in which attributes the keywords are searched.
    ...
    /// <code>publishedAt</code> = sort by publication date, the articles with the most recent publication date are returned first
    /// <code>relevance</code> = sort by best match to keywords, the articles with the best match are returned first
    /// </summary>
